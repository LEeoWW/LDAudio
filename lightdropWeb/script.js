...
let data = {
    ...
    espanyolUmb: {
     ...
     espanyolOtras: {
         ...
         description3:"",
         description4:"El instrumento musical interactivo, inspirado en la kalimba, se ha diseñado para ser inclusivo, incorporando LEDs de colores y Braille para personas con discapacidad visual y considerando la accesibilidad para aquellos con dificultades auditivas. Además, se ha adaptado para reducir el estrés en niños con autismo en entornos públicos y para facilitar su uso a adultos mayores, promoviendo la participación de todos en la experiencia musical.",
         description5:"Sistema implementado en uno de los microcontroladores Arduino de la maqueta. En el banco se integra una pantalla para la visualización del tiempo y que tiene la capacidad de producir melodías cuando se detecta la presión.",
     },
     valencianoOtras: {
          menu:"menú",
          galeria:"galeria",
         ...
         description2:" El pont servix com una important via de transport i està equipat amb un *Arduino que utilitza un sistema de sensors de color per a indicar els canvis en el semàfor d'una manera accessible per a conductors daltònics, assegurant una conducció més segura i sense barreres. L'arpa és una combinació de la música i l'arquitectura que funciona amb làser.",
          description3:"",
          description4:"L'instrument musical interactiu, inspirat en la *kalimba, s'ha dissenyat per a ser inclusiu, incorporant Leds de colors i Braille per a persones amb discapacitat visual i considerant l'accessibilitat per a aquells amb dificultats auditives. A més, s'ha adaptat per a reduir l'estrés en xiquets amb autisme en entorns públics i per a facilitar el seu ús a adults majors, promovent la participació de tots en l'experiència musical.",
          description5:"Sistema implementat en un dels microcontroladors *Arduino de la maqueta. En el banc s'integra una pantalla per a la visualització del temps i que té la capacitat de produir melodies quan es detecta la pressió.",
     },  
     englishOtras: {
          menu:"menu",
          galeria:"gallery",
         ...
         description2:"The bridge serves as a major transportation route and is equipped with an Arduino that uses a color sensor system to indicate traffic light changes in a way accessible to color-blind drivers, ensuring safer, barrier-free driving. The harp is a laser-powered combination of music and architecture.",
          description3:"",
          description4:"The interactive musical instrument, inspired by the kalimba, has been designed to be inclusive, incorporating colored LEDs and Braille for the visually impaired and accessibility for the hearing impaired. In addition, it has been adapted to reduce stress for children with autism in public environments and to facilitate its use by older adults, promoting the participation of everyone in the musical experience.",
          description5:"System implemented in one of the Arduino microcontrollers of the model. A display is integrated in the bench to visualize the time and has the ability to produce melodies when pressure is detected.",
     },
